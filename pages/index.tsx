...
const HomePage: React.FC = () => {
  const seoData = {
    title: 'New News - Global News & Articles | Your Trusted News Source',
    description: 'Stay informed with New News - your trusted source for global news, breaking stories, in-depth analysis, and compelling articles from around the world. Covering politics, technology, business, science, and more.',
    ...
    openGraph: {
      title: 'New News - Global News & Articles',
